<template>
  ...
  <div v-show="visible" class="picture_preview_container">
    <div class="picture_preview_close" @click="close">
      <span class="iconfont icon-guanbi-tupianyulan" />
    </div>
    <div class="picture_preview_total">{{ this.index + 1 }} / {{ urlList.length }}</div>
    <div ref="picturePreviewWrapper" tabindex="-1" class="picture_preview_wrapper">
      ...
      <div class="picture_preview_actions">
        <div class="picture_preview_actions_inner">
          <span class="iconfont icon-tupianyulan-suoxiao" @click="handleActions('zoomOut')" />
          <span class="iconfont icon-tupianyulan-fangda" @click="handleActions('zoomIn')" />
          <span
            class="iconfont"
            :class="
              mode.name === 'contain' ? 'icon-tupianyulan-zhengchangbili' : 'icon-tupianyulan-1bi1'
            "
            @click="toggleMode"
          />
          <span
      ...
      <div v-if="urlList.length > 1" class="picture_preview_toggle">
        <span
  ...
  methods: {
    ...
    moveFuncMobile(e) {
      ...
      if (e.touches.length > 1) {
        const now = e.touches
        const scale =
          this.getDistance(now[0], now[1]) / this.getDistance(this.start[0], this.start[1])
